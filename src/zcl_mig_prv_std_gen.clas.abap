" Install this executor with ABAP language version Standard ABAP.
" Uses the classic XCO signatures supplied from S40, not XCO_CP_GENERATION.
...
CLASS zcl_mig_prv_std_gen IMPLEMENTATION.
  ...
  METHOD zif_mig_prv_clas_gen~generate.
    ...
    TRY.
        ...
        "Warnings alone do not block the next generation stage.
