...
CLASS zcl_ce_business_logic_qp IMPLEMENTATION.
  METHOD if_rap_query_provider~select.
    ...
    " ĐỌC TỪ DATABASE
    DATA lt_rap_logic TYPE TABLE OF zce_business_logic.
    ...
    IF lv_top > 0.
      ...
      LOOP AT lt_rap_logic INTO DATA(ls_row) FROM lv_from TO lv_to.
    ...
    IF io_request->is_total_numb_of_rec_requested( ).
      io_response->set_total_number_of_records( lines( lt_rap_logic ) ).
    ENDIF.
  ENDMETHOD.
ENDCLASS.
